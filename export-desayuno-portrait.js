...
const URL = 'http://localhost:8080/carrusel-desayuno-portrait';
const OUT = path.join(__dirname, 'carrusel-desayuno-portrait-slides');
...
console.log(`found ${n} desayuno slides — exporting`);
for (let i = 0; i < n; i++) {
