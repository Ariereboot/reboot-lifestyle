...
const URL = 'http://localhost:8080/carrusel-antojos-portrait';
const OUT = path.join(__dirname, 'carrusel-antojos-portrait-slides');
...
console.log(`found ${n} slides — exporting portrait 1080x1350`);
for (let i = 0; i < n; i++) {
